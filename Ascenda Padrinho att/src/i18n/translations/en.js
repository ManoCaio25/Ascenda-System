  ...
  activityGenerator: {
    ...
    feedback: {
      ...
      previewReadyNoTranscript:
        "Preview ready! We couldn't retrieve the video transcript, so the plan leans on the title and description.",
      previewReadyNoDocument:
        "Preview ready! We couldn't read the document text, so the plan leans on your description.",
