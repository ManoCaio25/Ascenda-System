const pt = {
  ...
  activityGenerator: {
    ...
    feedback: {
      ...
      previewReadyNoTranscript:
        "Prévia pronta! Não conseguimos buscar a transcrição do vídeo, então usamos o título e a descrição.",
      previewReadyNoDocument:
        "Prévia pronta! Não conseguimos ler o texto do documento, então usamos a sua descrição.",
