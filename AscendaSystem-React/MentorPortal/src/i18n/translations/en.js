const en = {
  ...
  activityGenerator: {
    ...
    form: {
      ...
      videoLessonCount: "Video lessons",
    ...
    feedback: {
      ...
      missingPreviewActivities: "Keep at least one activity in the preview before saving.",
    ...
    preview: {
      ...
      videoLessonsTitle: "Recommended video lessons",
      lessonMeta: "{{minutes}} min - {{level}}",
      viewLesson: "View video lesson",
