...
export default function Dashboard() {
  ...
  const canManageIntern = (intern, currentUser) => {
    ...
    return (
      String(intern.mentor_id || "") === userId ||
      String(intern.substitute_mentor_id || "") === userId ||
      intern.mentor_name === userName ||
      intern.substitute_mentor_name === userName
    );
  };
  ...
  const loadData = async () => {
    ...
    const visibleInterns = currentUser
      ? internsData.filter((intern) => canManageIntern(intern, currentUser))
      : internsData;
