                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {user.mentor_name && (
                          <p className="mt-2 text-xs text-text-secondary truncate">
                            Mentor: <span className="text-text-primary">{user.mentor_name}</span>
                          </p>
                        )}
                        {user.substitute_mentor_name && (
                          <p className="mt-1 text-xs text-text-secondary truncate">
                            Substituto: <span className="text-text-primary">{user.substitute_mentor_name}</span>
                          </p>
                        )}
                      </div>
                    </div>
