...
function construirUrlLoading(alvo) {
  const url = new URL("../LoadingPage/index.html", window.location.href);
...
function redirecionarParaLoading(alvo) {
  const targets = {
    padrinho: "/AscendaSystem-React/Padrinho/index.html",
    estagiario: "/AscendaSystem-React/Estagiario/index.html",
  };
  window.location.href = construirUrlLoading(targets[alvo] || alvo);
}
